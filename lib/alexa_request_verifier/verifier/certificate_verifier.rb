  ...
  module Verifier
    ...
    module CertificateVerifier
      ...
      class << self
        ...
        #
        # @raise [AlexaRequestVerifier::InvalidCertificateError] raised if the certificate is not in date
        ...
        # @param [OpenSSL::X509::Certificate] certificate the certificate we should check
        #
        # @raise [AlexaRequestVerifier::InvalidCertificateError] raised if the extensions are not present
        ...
        # @param [Array<OpenSSL::X509::Certificate>] chain chain of certificates to a root trusted CA
        #
        # @raise [AlexaRequestVerifier::InvalidCertificateError] raised if a chain of trust could not be established
        def check_that_we_can_create_a_chain_of_trust_to_a_root_ca(certificate, chain)
          ...
          raise AlexaRequestVerifier::InvalidCertificateError, "Unable to create a 'chain of trust' from the provided certificate to a trusted root CA." unless valid_certificate_chain
        end
      end
    end
  end
